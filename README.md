...
<sub>02 · Gnosis Glyph Engine animated mechanics diagram · b-cell b-codec-mechanics cell-5 row-2</sub>
<figure>
...
<div><b>02 · MARKETS</b><span>ADJACENT FORECASTS</span></div>
      <div>
        <div>
          <div><span>Computer vision software</span><span></span><span>'31 · $45.9B</span></div>
          <div><span>OCR software</span><span></span><span>'30 · $22.4B</span></div>
          <div><span>Document AI</span><span></span><span>'30 · $17.2B</span></div>
          <div><span>Heritage digitization</span><span></span><span>'30 · $8.1B</span></div>
...
<div><b>05.3 · BENCHMARKS</b><span>BORROWED-ARM RESULTS</span></div>
      <div>
        ...
        <div>
          <div><span>HOG &sigma;</span><span></span><span>1.15</span></div>
          <div><span>Hu &sigma;</span><span></span><span>2.95</span></div>
          <div><span>ORB &sigma;</span><span></span><span>4.14</span></div>
        </div>
      </div>
...
<div><b>06.1 · COMPARATIVE PERFORMANCE · 10-SEED SIGMA</b></div>
      <div>
        <div>
          <div><span>HOG (borrowed)</span><span></span><span>&sigma; 1.15 &middot; most stable</span></div>
          <div><span>Hu regionprops (borrowed)</span><span></span><span>&sigma; 2.95</span></div>
          <div><span>OpenCV ORB (borrowed)</span><span></span><span>&sigma; 4.14</span></div>
          <div><span>Owned descriptor</span><span></span><span>UNTESTED &middot; D-06 unblocks</span></div>
        </div>
      </div>
